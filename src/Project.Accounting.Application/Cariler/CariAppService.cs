...
[Authorize(AccountingPermissions.Cari.Default)]
public class CariAppService : AccountingAppService, ICariAppService
{
    ...
    [Authorize(AccountingPermissions.Cari.Create)]
    ...
    [Authorize(AccountingPermissions.Cari.Update)]
    ...
    [Authorize(AccountingPermissions.Cari.Delete)]
