...
[Authorize(AccountingPermissions.Kasa.Default)]
public class KasaAppService : AccountingAppService, IKasaAppService
{
    ...
    [Authorize(AccountingPermissions.Kasa.Create)]
    ...
    [Authorize(AccountingPermissions.Kasa.Update)]
    ...
    [Authorize(AccountingPermissions.Kasa.Delete)]
