...
[Authorize(AccountingPermissions.Masraf.Default)]
public class MasrafAppService : AccountingAppService, IMasrafAppService
{
    ...
    [Authorize(AccountingPermissions.Masraf.Create)]
    ...
    [Authorize(AccountingPermissions.Masraf.Update)]
    ...
    [Authorize(AccountingPermissions.Masraf.Delete)]
