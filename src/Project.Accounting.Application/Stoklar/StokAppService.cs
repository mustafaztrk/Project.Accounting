...
[Authorize(AccountingPermissions.Stok.Default)]
public class StokAppService : AccountingAppService, IStokAppService
{
    ...
    [Authorize(AccountingPermissions.Stok.Create)]
    ...
    [Authorize(AccountingPermissions.Stok.Update)]
    ...
    [Authorize(AccountingPermissions.Stok.Delete)]
