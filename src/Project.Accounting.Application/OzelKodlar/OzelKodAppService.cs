...
[Authorize(AccountingPermissions.OzelKod.Default)]
public class OzelKodAppService : AccountingAppService, IOzelKodAppService
{
    ...
    [Authorize(AccountingPermissions.OzelKod.Create)]
    ...
    [Authorize(AccountingPermissions.OzelKod.Update)]
    ...
    [Authorize(AccountingPermissions.OzelKod.Delete)]
