...
[Authorize(AccountingPermissions.Fatura.Default)]
public class FaturaAppService : AccountingAppService, IFaturaAppService
{
    ...
    [Authorize(AccountingPermissions.Fatura.Create)]
    ...
    [Authorize(AccountingPermissions.Fatura.Update)]
    ...
    [Authorize(AccountingPermissions.Fatura.Delete)]
