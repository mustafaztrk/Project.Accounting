...
[Authorize(AccountingPermissions.Donem.Default)]
public class DonemAppService : AccountingAppService, IDonemAppService
{
    ...
    [Authorize(AccountingPermissions.Donem.Create)]
    ...
    [Authorize(AccountingPermissions.Donem.Update)]
    ...
    [Authorize(AccountingPermissions.Donem.Delete)]
