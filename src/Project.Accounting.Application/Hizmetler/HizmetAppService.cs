...
[Authorize(AccountingPermissions.Hizmet.Default)]
public class HizmetAppService : AccountingAppService, IHizmetAppService
{
    ...
    [Authorize(AccountingPermissions.Hizmet.Create)]
    ...
    [Authorize(AccountingPermissions.Hizmet.Update)]
    ...
    [Authorize(AccountingPermissions.Hizmet.Delete)]
