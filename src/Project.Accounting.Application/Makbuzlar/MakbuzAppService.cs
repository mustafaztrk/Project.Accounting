...
[Authorize(AccountingPermissions.Makbuz.Default)]
public class MakbuzAppService : AccountingAppService, IMakbuzAppService
{
    ...
    [Authorize(AccountingPermissions.Makbuz.Create)]
    ...
    [Authorize(AccountingPermissions.Makbuz.Update)]
    ...
    [Authorize(AccountingPermissions.Makbuz.Delete)]
