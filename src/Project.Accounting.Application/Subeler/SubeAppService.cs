...
[Authorize(AccountingPermissions.Sube.Default)]
public class SubeAppService : AccountingAppService, ISubeAppService
{
    ...
    [Authorize(AccountingPermissions.Sube.Create)]
    ...
    [Authorize(AccountingPermissions.Sube.Update)]
    ...
    [Authorize(AccountingPermissions.Sube.Delete)]
