...
[Authorize(AccountingPermissions.Birim.Default)]
public class BirimAppService : AccountingAppService, IBirimAppService
{
    ...
    [Authorize(AccountingPermissions.Birim.Create)]
    ...
    [Authorize(AccountingPermissions.Birim.Update)]
    ...
    [Authorize(AccountingPermissions.Birim.Delete)]
