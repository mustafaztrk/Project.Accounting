...
[Authorize(AccountingPermissions.Depo.Default)]
public class DepoAppService : AccountingAppService, IDepoAppService
{
    ...
    [Authorize(AccountingPermissions.Depo.Create)]
    ...
    [Authorize(AccountingPermissions.Depo.Update)]
    ...
    [Authorize(AccountingPermissions.Depo.Delete)]
