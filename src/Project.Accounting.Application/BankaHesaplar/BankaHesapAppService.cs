...
[Authorize(AccountingPermissions.BankaHesap.Default)]
public class BankaHesapAppService : AccountingAppService, IBankaHesapAppService
{
    ...
    [Authorize(AccountingPermissions.BankaHesap.Create)]
    ...
    [Authorize(AccountingPermissions.BankaHesap.Update)]
    ...
    [Authorize(AccountingPermissions.BankaHesap.Delete)]
