...
namespace Project.Accounting.Migrations
{
    ...
    [Migration("20221210200345_AllEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project.Accounting.BankaHesaplar.BankaHesap", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Project.Accounting.Bankalar.Banka", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.BankaSubeler.BankaSube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Birimler.Birim", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Cariler.Cari", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Depolar.Depo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Donemler.Donem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Faturalar.Fatura", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Faturalar.FaturaHareket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Hizmetler.Hizmet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Kasalar.Kasa", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Makbuzlar.Makbuz", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Makbuzlar.MakbuzHareket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Masraflar.Masraf", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.OdemeBelgeleri.OdemeBelgesi", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.OzelKodlar.OzelKod", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Parametreler.FirmaParametre", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Raporlar.GirenCikanBakiye", b =>
                {
            ...
            modelBuilder.Entity("Project.Accounting.Raporlar.OdemeBelgeleriDagilim", b =>
                {
                    b.Property<byte>("OdemeTuru")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Project.Accounting.Stoklar.Stok", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.Subeler.Sube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Accounting.BankaHesaplar.BankaHesap", b =>
                {
                    b.HasOne("Project.Accounting.BankaSubeler.BankaSube", "BankaSube")
                        .WithMany("BankaHesaplar")
                        .HasForeignKey("BankaSubeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Project.Accounting.OzelKodlar.OzelKod", "OzelKod1")
                        .WithMany("OzelKod1BankaHesaplar")
                        .HasForeignKey("OzelKod1Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Project.Accounting.OzelKodlar.OzelKod", "OzelKod2")
                        .WithMany("OzelKod2BankaHesaplar")
                        .HasForeignKey("OzelKod2Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Project.Accounting.Subeler.Sube", "Sube")
                        .WithMany("BankaHesaplar")
            ...
            modelBuilder.Entity("Project.Accounting.BankaSubeler.BankaSube", b =>
                {
                    b.HasOne("Project.Accounting.Bankalar.Banka", "Banka")
            ...
            modelBuilder.Entity("Project.Accounting.Faturalar.Fatura", b =>
                {
                    b.HasOne("Project.Accounting.Cariler.Cari", "Cari")
                        .WithMany("Faturalar")
                        .HasForeignKey("CariId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Project.Accounting.Donemler.Donem", "Donem")
                        .WithMany("Faturalar")
            ...
            modelBuilder.Entity("Project.Accounting.Faturalar.FaturaHareket", b =>
                {
                    b.HasOne("Project.Accounting.Depolar.Depo", "Depo")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("DepoId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Project.Accounting.Faturalar.Fatura", "Fatura")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("FaturaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Project.Accounting.Hizmetler.Hizmet", "Hizmet")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("HizmetId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Project.Accounting.Masraflar.Masraf", "Masraf")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("MasrafId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Project.Accounting.Stoklar.Stok", "Stok")
                        .WithMany("FaturaHareketler")
            ...
            modelBuilder.Entity("Project.Accounting.Hizmetler.Hizmet", b =>
                {
                    b.HasOne("Project.Accounting.Birimler.Birim", "Birim")
                        .WithMany("Hizmetler")
            ...
            modelBuilder.Entity("Project.Accounting.Makbuzlar.Makbuz", b =>
                {
                    b.HasOne("Project.Accounting.BankaHesaplar.BankaHesap", "BankaHesap")
                        .WithMany("Makbuzlar")
                    ...
                    b.HasOne("Project.Accounting.Kasalar.Kasa", "Kasa")
                        .WithMany("Makbuzlar")
            ...
            modelBuilder.Entity("Project.Accounting.Makbuzlar.MakbuzHareket", b =>
                {
                    ...
                    b.HasOne("Project.Accounting.Bankalar.Banka", "CekBanka")
                        .WithMany("MakbuzHareketler")
                        .HasForeignKey("CekBankaId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Project.Accounting.BankaSubeler.BankaSube", "CekBankaSube")
                        .WithMany("MakbuzHareketler")
                    ...
                    b.HasOne("Project.Accounting.Makbuzlar.Makbuz", "Makbuz")
                        .WithMany("MakbuzHareketler")
            ...
            modelBuilder.Entity("Project.Accounting.Parametreler.FirmaParametre", b =>
                {
                    ...
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("Project.Accounting.Parametreler.FirmaParametre", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
